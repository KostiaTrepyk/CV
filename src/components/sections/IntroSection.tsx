...
import { navHeight } from "components/layout/Nav/Nav";
...
const IntroSection = forwardRef<HTMLElement, IntroSectionProps>((_, ref) => {
    ...
    const carouselImages: { src: string; alt: string }[] = [
        ...
        {
            src: cloudstorageserver1,
            alt: "Cloud Storage server 1",
        },
        {
            src: cloudstorageserver2,
            alt: "Cloud Storage server 2",
        },
        {
            src: chat,
            alt: "Chat",
            ...
            >
                ...
                >
                    ...
                    <MTypography
                        ...
                        variant="body1"
                    >
                        Welcome to my world of front-end development, where
                        creativity meets functionality to craft exceptional
                        digital experiences.
                    </MTypography>
