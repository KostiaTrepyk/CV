import { Children, forwardRef, memo, useCallback, useEffect, useRef, useState } from "react";
				...
				>
					<div className={styles.currentSlide}>
						{Children.map(children, (child, index) => (
							<Slide duration={duration} active={index === current}>
								{child}
							</Slide>
						))}
					</div>
					...
					>
						{Children.map(children, (child, index) => (
							<Slide duration={duration} active={index === next}>
								{child}
							</Slide>
						))}
					</div>
